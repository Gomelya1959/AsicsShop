...
public class ProductDAOImpl implements ProductDAO {
    ...
    public ProductInfo findProductInfo(String code) {
        ...
        return new ProductInfo(product.getCode(), product.getName(), product.getPrice(), product.getSurplus(), product.getDiscount());
    }
    ...
    public void save(ProductInfo productInfo) {
        ...
        product.setSurplus(productInfo.getSurplus());

        if (productInfo.getFileData() != null && !productInfo.isNotImage()) {
    ...
    public PaginationResult<ProductInfo> queryProducts(int page, int maxResult, int maxNavigationPage,
        ...
        String sql = "Select new " + ProductInfo.class.getName() //
                + "(p.code, p.name, p.price, p.surplus, p.discount) " + " from "//
